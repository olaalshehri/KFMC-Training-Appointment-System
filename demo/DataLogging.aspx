<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DataLogging.aspx.cs" I
    nherits="KFCproject.demo.DataLogging"   EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        ...
        <td>
         ...
         <div>
          <asp:GridView ID="gvcontact" runat="server" AutoGenerateColumns="False" DataKeyNames="LoginId" OnSelectedIndexChanged="gvcontact_SelectedIndexChanged"    >
            <Columns>
